                            ...
                            <div class="row">                               
                              <div class="col-md-12">
                                  ...
                                  <div class="margin-top-10">
                                      ...
                                      <input type="hidden" name="update_notification_id" value="<?php echo $notification_data['ID']; ?>">
                                      <input type="submit" class="btn green" name="update_notification" value="Update Now">
                                  </div>
                              </div>
                            </div>
                          </form>
