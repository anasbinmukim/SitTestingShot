      ...
      <div class="portlet light portlet-fit ">
          <div class="portlet-title">
              <div class="caption">
                  ...
                  <span class="caption-subject font-red sbold uppercase">Zone</span>
              </div>
              <div class="actions">
                  ...
                  <tbody>
                    <?php foreach ($zone_rows as $zone) { ?>
                        <tr>
                            ...
                            <td><a data-action_type = "delete" data-division_id = "<?php echo $zone->ID; ?>" data-db_table="place_division" class="delete" href="javascript:;"> Delete </a></td>
                            <input type="hidden" class="division_id" value="<?php echo $zone->ID; ?>">
