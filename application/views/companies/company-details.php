<!-- BEGIN PAGE HEADER-->
<h1 class="page-title"><?php echo html_escape($company_data['company_name']); ?></h1>
<div class="page-bar">
    <ul class="page-breadcrumb">
        ...
        <li>
            <span><?php echo html_escape($company_data['company_name']); ?></span>
        </li>
    </ul>
</div>
<!-- END PAGE HEADER-->
                  ...
                  <div class="portlet light ">
                      <div class="portlet-title tabbable-line">
                          <div class="caption caption-md">
                              ...
                              <span class="caption-subject font-blue-madison bold uppercase"><?php echo $company_data['company_name']; ?></span>
                          </div>
                      </div>
