var TableDivisionEditable = function () {
    ...
    var handleTable = function () {
        ...
        function editRow(oTable, nRow) {
            var aData = oTable.fnGetData(nRow);
            var jqTds = $('>td', nRow);
            jqTds[0].innerHTML = '<input type="text" name="district_name" class="form-control division_name input-small" value="' + aData[0] + '">';
        ...
        var table = $('#district_editable_view');
        ...
        var tableWrapper = $("#district_editable_view_wrapper");

        var nEditing = null;
        var nNew = false;

        $('#district_editable_view_new').click(function (e) {
            e.preventDefault();
