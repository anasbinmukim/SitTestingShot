var TableDataLaunchBookingAjax = function () {
        ...
        grid.init({
            ...
            dataTable: { // here you can define a typical datatable settings from http://datatables.net/usage/options
                ...
                "fnStateSaveParams":    function ( oSettings, sValue ) {
                    $("#datatable_manage_booking tr.filter .form-control").each(function() {
                ...
                "ajax": {
                    "url": $("#datatable_manage_booking").data('url'),
                },
                "order": [
                    [1, "asc"]
...
jQuery(document).ready(function() {
    TableDataLaunchBookingAjax.init();
});
